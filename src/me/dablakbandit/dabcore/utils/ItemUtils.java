...
public class ItemUtils{
	...
	private static Class<?> nmrs = NMSUtils.getClass("net.minecraft.util.registry.RegistrySimple");
	...
	public static Class<?> nbtby = NMSUtils.getClass("net.minecraft.nbt.NBTTagByte");
	public static Class<?> nbtba = NMSUtils.getClass("net.minecraft.nbt.NBTTagByteArray");
	public static Class<?> nbtd = NMSUtils.getClass("net.minecraft.nbt.NBTTagDouble");
	public static Class<?> nbtf = NMSUtils.getClass("net.minecraft.nbt.NBTTagFloat");
	public static Class<?> nbti = NMSUtils.getClass("net.minecraft.nbt.NBTTagInt");
	public static Class<?> nbtia = NMSUtils.getClass("net.minecraft.nbt.NBTTagIntArray");
	public static Class<?> nbtl = NMSUtils.getClass("net.minecraft.nbt.NBTTagList");
	public static Class<?> nbtlo = NMSUtils.getClass("net.minecraft.nbt.NBTTagLong");
	public static Class<?> nbts = NMSUtils.getClass("net.minecraft.nbt.NBTTagShort");
	public static Class<?> nbtst = NMSUtils.getClass("net.minecraft.nbt.NBTTagString");
	...
	public static Field nbtbd = NMSUtils.getField(nbtby, "field_74756_a");
	public static Field nbtbad = NMSUtils.getField(nbtba, "field_74754_a");
	public static Field nbtdd = NMSUtils.getField(nbtd, "field_74755_a");
	public static Field nbtfd = NMSUtils.getField(nbtf, "field_74750_a");
	public static Field nbtid = NMSUtils.getField(nbti, "field_74748_a");
	public static Field nbtiad = NMSUtils.getField(nbtia, "field_74749_a");
	public static Field nbtld = NMSUtils.getField(nbtl, "field_74747_a");
	public static Field nbtlt = NMSUtils.getField(nbtl, "field_74746_b");
	public static Field nbttcd = NMSUtils.getField(nbttc, "map");
	public static Field nbtlod = NMSUtils.getField(nbtlo, "field_74753_a");
	public static Field nbtsd = NMSUtils.getField(nbts, "field_74752_a");
	public static Field nbtstd = NMSUtils.getField(nbtst, "field_74751_a");
